...
export function Hero() {
  return (
    <section
      ...
      className="graticule -mt-16 flex min-h-[100dvh] items-center border-b border-grid pt-20 pb-16 sm:pt-24"
    >
      <div className="mx-auto grid w-full max-w-[1400px] grid-cols-1 gap-12 px-6 lg:grid-cols-12 lg:gap-6">
        <div className="lg:col-span-8">
          <h1
            id="hero-heading"
            className="text-64 leading-[0.92] tracking-[-0.03em] text-bone text-balance lg:text-104"
          >
            {identity.name}
          </h1>
