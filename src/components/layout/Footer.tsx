  ...
  return (
    <footer className="border-t border-rule">
      <div className="mx-auto flex max-w-[1400px] flex-col gap-6 px-6 py-10 sm:flex-row sm:items-center sm:justify-between">
        ...
        <ul aria-label="Contact links" className="flex flex-wrap gap-x-6 gap-y-2 font-mono text-12 text-muted">
          <li>
            <a
              href={`mailto:${identity.email}`}
              className="transition-colors hover:text-ink focus-visible:outline-2 focus-visible:outline-signal focus-visible:outline-offset-4"
            >
              {identity.email}
            </a>
          </li>
