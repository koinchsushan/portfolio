...
export const roles: Role[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "Built the platform's shared React component library (Material UI, Styled-components) to WCAG 2.1 AA, giving every feature team one accessible, Figma-accurate source of UI truth across squads.",
  ...
  },
  {
    ...
    bullets: [
      ...
      'Self-service dataset upload, validated, atomically written and revertible in one click, backed by a 21-test suite.',
