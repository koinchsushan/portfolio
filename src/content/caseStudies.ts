...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    situation: [
      ...
      'Every squad shipped through one coordinated release train, and a shared UI layer that predated the platform\'s growth left global and async state across eligibility processing, contract configuration and employee data management prone to cross-module inconsistencies — surfacing stale records to users.',
    ],
    constraint:
